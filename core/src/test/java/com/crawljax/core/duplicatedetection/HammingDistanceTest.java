...
public class HammingDistanceTest {
	...
	public void testIsNearDuplicateOnBoundary() {
		...
		NearDuplicateDetectionCrawlhash crawlhash = new NearDuplicateDetectionCrawlhash(3, features, hasher);
		...
		Fingerprint fpHash = new CrawlhashFingerprint(hash1AsInt, crawlhash.getThreshold());
		Fingerprint fpThreeBitsDIffHash = new CrawlhashFingerprint(hash2AsInt, crawlhash.getThreshold());
		...
		assertEquals(3, crawlhash.getThreshold(), 0.01);
	...
	public void testIsNearDuplicateOfBoundary() {
		...
		List<FeatureType> features = new ArrayList<>();
		features.add(new FeatureShingles(2, SizeType.CHARS));
		NearDuplicateDetectionCrawlhash crawlhash = new NearDuplicateDetectionCrawlhash(2, features, hasher);
		String hash = "01111111111111111111111111111111";
		String threeBitsDiffhash = "01111111111101111111110111110111";

		int hash1AsInt = Integer.parseInt(hash, (int) crawlhash.getThreshold());
		int hash2AsInt = Integer.parseInt(threeBitsDiffhash, (int) crawlhash.getThreshold());
		...
		assertEquals(2, crawlhash.getThreshold(), 0.01);
